...
const tasksProject1: Task[] = [
  buildTask({
    id: "t-1",
    projectId: "proj-1",
    title: "Thiết kế UI trang Dashboard",
    status: TaskStatus.DONE,
    priority: TaskPriority.HIGH,
    description:
      "Xây dựng giao diện trang Dashboard với các widget thống kê, biểu đồ tiến độ, và danh sách công việc gần đây.",
    dueDate: "2026-06-15T17:00:00Z",
    estimatedMinutes: 480,
    completedAt: "2026-06-14T16:30:00Z",
    rank: "a",
    ...
    checklists: [
      ...
      },
      {
        id: "cl-2",
        taskId: "t-1",
        title: "Implement layout responsive",
        completed: true,
        createdAt: "2026-06-10T08:00:00Z",
        rank: "b",
      },
    ...
    comments: [
      {
        ...
        authorId: "u-2",
        authorName: "Minh Anh",
        content: "Thiết kế rất đẹp, approve! 🎉",
        edited: false,
  ...
  buildTask({
    id: "t-2",
    projectId: "proj-1",
    title: "Xây dựng API quản lý tài liệu",
    status: TaskStatus.IN_PROGRESS,
    priority: TaskPriority.URGENT,
    description:
      "Implement REST API cho upload, download, preview và chia sẻ tài liệu. Hỗ trợ PDF, DOCX, PPTX.",
    ...
    checklists: [
      ...
      },
      {
        id: "cl-5",
        taskId: "t-2",
        title: "Upload endpoint + MinIO integration",
        completed: true,
        createdAt: "2026-06-12T08:00:00Z",
        rank: "b",
      },
      {
        id: "cl-6",
        taskId: "t-2",
        title: "Download & preview endpoint",
        completed: false,
    ...
    comments: [
      {
        ...
        content: "Đã setup MinIO trên Docker, đang viết upload service.",
        edited: false,
      ...
      },
      {
        ...
        taskId: "t-2",
        authorId: "u-1",
        authorName: "Thanh Trí",
        content: "Nhớ xử lý file size limit là 50MB nhé @Hoàng Nam",
        edited: false,
  ...
  buildTask({
    id: "t-3",
    projectId: "proj-1",
    title: "Fix lỗi đăng nhập OAuth2 Google",
    status: TaskStatus.IN_REVIEW,
    priority: TaskPriority.HIGH,
    description:
      "Người dùng không thể đăng nhập bằng Google trên trình duyệt Safari. Cần kiểm tra lại redirect URI và session handling.",
    ...
    assignees: [
      {
        ...
        userId: "u-4",
        displayName: "Thu Hà",
        assignedAt: "2026-06-16T08:00:00Z",
      },
    ],
    checklists: [
      {
        id: "cl-8",
        taskId: "t-3",
        title: "Reproduce bug trên Safari",
        completed: true,
      ...
      },
      {
        id: "cl-10",
        taskId: "t-3",
        title: "Test lại trên các trình duyệt",
        completed: true,
  ...
  buildTask({
    id: "t-4",
    projectId: "proj-1",
    title: "Tích hợp AI tóm tắt tài liệu",
    status: TaskStatus.TODO,
    priority: TaskPriority.MEDIUM,
    description:
      "Kết nối Document Service với AI Service để tự động tóm tắt nội dung khi người dùng upload tài liệu mới.",
  ...
  buildTask({
    ...
    description:
      "Viết unit test cho các endpoint authentication: login, register, refresh token, logout.",
  ...
  buildTask({
    ...
    priority: TaskPriority.HIGH,
    description:
      "Xây dựng giao diện Kanban Board cho module quản lý dự án với drag-and-drop.",
    ...
    assignees: [
      {
        ...
        userId: "u-1",
        displayName: "Thanh Trí",
        assignedAt: "2026-06-22T08:00:00Z",
      },
      {
        id: "ta-8",
        taskId: "t-6",
  ...
  buildTask({
    ...
    priority: TaskPriority.MEDIUM,
    description:
      "Cấu hình GitHub Actions cho build, test và deploy tự động lên staging server.",
    estimatedMinutes: 240,
    completedAt: "2026-06-08T15:00:00Z",
    rank: "g",
    labels: [labelsProject1[1]],
    assignees: [
      {
  ...
  buildTask({
    id: "t-8",
    projectId: "proj-1",
    title: "Tạo component Calendar View",
    status: TaskStatus.TODO,
    priority: TaskPriority.MEDIUM,
    description:
      "Xây dựng giao diện lịch hiển thị các task theo ngày/tuần/tháng với due date.",
...
const tasksProject2: Task[] = [
  buildTask({
    id: "t-9",
    projectId: "proj-2",
    title: "Thu thập tài liệu chương 1-3",
    status: TaskStatus.DONE,
    priority: TaskPriority.HIGH,
  ...
  buildTask({
    id: "t-10",
    projectId: "proj-2",
    title: "Viết nội dung chương 4: Phân tích thiết kế",
    status: TaskStatus.IN_PROGRESS,
    priority: TaskPriority.URGENT,
    dueDate: "2026-06-30T17:00:00Z",
    estimatedMinutes: 600,
  ...
  buildTask({
    id: "t-11",
    projectId: "proj-2",
    title: "Review và chỉnh sửa chương 1-2",
    status: TaskStatus.TODO,
    priority: TaskPriority.MEDIUM,
    ...
    assignees: [
      {
        ...
        userId: "u-6",
        displayName: "Lan Phương",
        assignedAt: "2026-04-20T08:00:00Z",
      },
    ],
  }),
  buildTask({
    id: "t-13",
    projectId: "proj-3",
    title: "Tổ chức meeting kick-off",
    status: TaskStatus.DONE,
    priority: TaskPriority.MEDIUM,
    estimatedMinutes: 60,
