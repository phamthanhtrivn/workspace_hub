      ...
      <div className="p-4 border-b border-gray-100">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <button className="p-2 bg-gray-100 hover:bg-gray-200 rounded-full text-gray-600 transition">
              <UserPlus size={18} />
            </button>
            ...
            >
              ...
              <div className="ml-3 flex-1 overflow-hidden">
                <div className="flex justify-between items-baseline">
                  <h3 className="font-semibold text-sm text-gray-800 truncate">Team Project</h3>
                  <span className="text-xs text-gray-500">10:42 AM</span>
                </div>
                <p className="text-sm text-gray-500 truncate">Can we review the new design?</p>
              </div>
            </div>
          </div>
        )}
        ...
        {(activeTab === 'all' || activeTab === 'personal') && (
          <div className="space-y-1 mt-1">
            ...
            >
              ...
              <div className="ml-3 flex-1 overflow-hidden">
                <div className="flex justify-between items-baseline">
                  <h3 className="font-semibold text-sm text-gray-800 truncate">Alice Smith</h3>
                  <span className="text-xs text-blue-600 font-medium">Yesterday</span>
                </div>
                <p className="text-sm text-gray-800 font-medium truncate">Sounds good!</p>
              </div>
              <div className="ml-2 w-5 h-5 bg-blue-500 rounded-full flex items-center justify-center text-white text-[10px] font-bold">2</div>
            </div>
          </div>
        )}
      </div>
