...
import { searchUserByEmail } from "../api/chat.api";
          ...
          {!loading &&
            ...
            email.trim() !== "" && (
              <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
                ...
                <p className="text-gray-500 font-medium">Không có kết quả</p>
              </div>
            )}
              ...
              {results.map((user) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="shrink-0 bg-white border border-gray-200 text-gray-700 px-4 py-2 rounded-full hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-md font-medium text-sm transition-all duration-200 ml-2"
                  >
                    Nhắn tin
                  </button>
                </div>
