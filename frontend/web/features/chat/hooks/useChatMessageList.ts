...
import { ChatContextType, ChatMessageResponse, PaginatedMessagesResponse } from "../types/chat.types";
import { chatKeys, CHAT_DEFAULT_MESSAGE_PAGE_SIZE } from "../types/chat.constant";
...
export interface UseChatMessageListReturn {
  ...
  setNewSocketMessages: React.Dispatch<React.SetStateAction<ChatMessageResponse[]>>;
}
...
export function useChatMessageList({
  ...
  }, [isBottomInView, hasPreviousPage, isFetchingPreviousPage, fetchPreviousPage]);
