...
export const FILE_EXTENSIONS = {
  ...
  CODE: [
    ...
    "html", "css",
    "json",
    "py", "java", "cpp", "c", "cs", "go", "rs", "php", "sh",
    "yaml", "yml", "xml", "sql",
    "env", "gitignore", "dockerfile", "npmrc", "editorconfig",
  ] as const,
  ...
  TEXT_PREVIEW: [
    "txt", "log", "md", "csv",
    "json", "js", "ts", "jsx", "tsx", "css", "html",
    "py", "java", "c", "cpp", "h", "cs", "go", "rs", "php", "sh",
    "yaml", "yml", "ini", "xml", "sql",
    "env", "gitignore", "dockerfile", "npmrc", "editorconfig",
  ] as const,
} as const;
...
export const EXTENSION_TO_TYPE: Record<string, DocumentTypeDescription> = {
  // PDF
  ...Object.fromEntries(FILE_EXTENSIONS.PDF.map((e) => [e, DocumentTypeDescription.PDF])),
  // Word
  ...Object.fromEntries(FILE_EXTENSIONS.WORD.map((e) => [e, DocumentTypeDescription.WORD])),
  // Excel
  ...Object.fromEntries(FILE_EXTENSIONS.EXCEL.map((e) => [e, DocumentTypeDescription.EXCEL])),
  // PowerPoint
  ...Object.fromEntries(FILE_EXTENSIONS.POWERPOINT.map((e) => [e, DocumentTypeDescription.POWERPOINT])),
  // Archive
