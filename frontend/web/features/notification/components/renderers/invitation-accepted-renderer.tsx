...
export const InvitationAcceptedModalRenderer: React.FC<{
  notification: Notification;
  onClose: () => void;
    ...
    <div className="p-5">
      <div className="flex flex-col items-center justify-center mb-6 text-center">
        <div className="relative mb-4">
          <div className="relative h-16 w-16 rounded-full overflow-hidden shadow-sm border-2 border-white ring-4 ring-emerald-50 bg-emerald-100 flex items-center justify-center text-emerald-500">
            {notification.senderAvatar ? (
              <Image
                src={notification.senderAvatar}
                alt="Avatar"
