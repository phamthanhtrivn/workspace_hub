...
export enum SPACE_ERROR_MESSAGES {
  ...
  OWNER_REQUIRED = 'Only the space owner can perform this action',
  OWNER_TRANSFER_REQUIRED = 'Only the space owner can transfer ownership',
  ...
  PROJECT_SPACE_MANAGED_BY_PROJECT = 'Project space is managed from the project',
}
